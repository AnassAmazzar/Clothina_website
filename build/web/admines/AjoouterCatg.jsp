<%-- 
    Document   : AjoouterCatg
    Created on : 2 mars 2022, 15:00:21
    Author     : 
--%>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Catégorie</h3><!--<small>jQuery Validation</small>-->
                                    </div>
                                    <form action="<%=request.getContextPath()%>/ServletCateg" method="post" id="quickForm" novalidate="novalidate">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Disiniation</label>
                                                <input type="text" name="disiniation" class="form-control" id="exampleInputPassword1" placeholder="Disiniation">
                                            </div>
