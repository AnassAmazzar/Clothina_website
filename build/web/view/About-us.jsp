<%-- 
    Document   : About-us
    Created on : 5 avr. 2022, 12:41:04
    Author     : anass
--%>
...
<head>
    ...
    <body id="about-us" class="index layout2 layout4">
            ...
            <div class="container">
                <div class="row align-items-center about-main">
                    <div class="col-12 col-lg-5 text-center col-left">
                        <img src="img/banner/aboutt-us.jpg" alt="" class="border-radius-6 w-100" data-no-retina="">
                    </div>
                    <div class="col-12 col-lg-7 col-right">
                        <span class="d-inline-block title mb-10">Ne vous inquiétez pas, vous êtes entre de bonnes mains.</span>
                        <h6 class="d-inline-block desc mb-30 font-weight-bold">Nous nous engageons pour le succès de nos clients du début à la fin. Notre apport aide à élaborer leurs solutions.</h6>
                        <p class="m-0 sub-desc ">Clothina est une marque marocaine dont la collection est fabriquée à 100% en Maroc.Constituée àla fois de collections permanentes et de collections capsules,en éditions limitées.
                          Ses inspirations La danse,la mer,la vie citadine,l'architecture et les longues soirées entre amis ou en famille.Des lignes intemporelles,féminines et minimalistes. Une marque pour les femmesàla féminité affirmée,qui osent et aiment jouer avec la mode.</p>
        ...
        <div id="about-main-2" class="float-left w-100 mb-150 mb-sm-30">
            <div class="d-flex d-lg-flex d-sm-block d-xs-block align-items-center about-main-2 bg-light">
                <div class="col-12 col-lg-6 col-right px-100">
                    <span class="d-inline-block title text-capitalize mb-150 text-center">Une raison de travailler ensemble.</span>
                ...
                <div class="col-12 col-lg-6 text-center col-left p-0">
                    <img src="img/banner/aboutt-us1.jpg" alt="" class="border-radius-6 w-100" data-no-retina="">
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="about-us-team">
                    <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                        <div class="team-block-inner position-relative">
                            <div class="team-image text-center">
                                <img src="img/banner/teamm-01.jpg" alt="team-01" />
                    ...
                    <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                        <div class="team-block-inner position-relative">
                            <div class="team-image text-center">
                                <img src="img/banner/teamm-02.jpg" alt="team-02" />
                                <div class="overlay"></div>
                            </div>
                            <div class="team-content text-center float-left w-100">
                                <div class="team-name text-capitalize font-weight-bold">john duff</div>
                    ...
                    <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                        <div class="team-block-inner position-relative">
                            <div class="team-image text-center">
                                <img src="img/banner/teamm-03.jpg" alt="team-03" />
                                <div class="overlay"></div>
                            </div>
                            <div class="team-content text-center float-left w-100">
                                <div class="team-name text-capitalize font-weight-bold">john duff</div>
                    ...
                    <div class="team-block col-sm-6 col-md-3 col-lg-3 float-left mb-sm-30">
                        <div class="team-block-inner position-relative">
                            <div class="team-image text-center">
                                <img src="img/banner/teamm-04.jpg" alt="team-04" />
                                <div class="overlay"></div>
                            </div>
                            <div class="team-content text-center float-left w-100">
                                <div class="team-name text-capitalize font-weight-bold">john duff</div>
            ...
            <div class="tttestimonial-content container">
                <div class="tttestimonial-inner">
                    <ul class="tttestimonial tttesti owl-carousel p-0">
                        ...
                        <li>
                            <div class="testimonial-block">
                                <div class="testimonial-image"><img alt="" src="img/banner/userr2.jpg" /></div>
                                <div class="testimonial-content">
                                    <div class="testimonial-desc">
                                        <div class="rating">
                                            <div class="product-ratings d-inline-block align-middle">
                        ...
                        <li>
                            <div class="testimonial-block">
                                <div class="testimonial-image"><img alt="" src="img/banner/userr3.jpg" /></div>
                                <div class="testimonial-content">
                                    <div class="testimonial-desc">
                                        <div class="rating">
                                            <div class="product-ratings d-inline-block align-middle">
