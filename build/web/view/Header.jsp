<%-- 
    Document   : Header
    Created on : 5 avr. 2022, 09:15:33
    Author     : anass
--%>
...
<header class="header-area header-sticky text-center header1">
	...
	<div class="container">
		<div class="nav-left float-left"><div class="ttheader-service">Un accès à des promotions exclusives et bien plus encore</div>
		</div><div class="nav-right float-right d-flex">
			<div class="language-wrapper toggle" style="visibility: hidden">
				<button type="button" class="btn text-capitalize dropdown-toggle"><img src="img/banner/frr.png" alt="fr"><span>French</span></button>
                                <div id="language-dropdown" class="language">
					<ul>
                                            <li><img src="img/banner/frr.png" alt="fr"><span>French</span></li>
                                            <li><img src="img/banner/enn.png" alt="en"><span>English</span></li>
...
<!--				<div class="currency-wrapper toggle">
		...
		<div class="ttheader-mail"><a href="mailto:anassamazzar1959@gmail.com">anassamazzar1959@gmail.com</a></div>
		<div class="contact">
						<i class="material-icons">phone</i>
						<span>0612883622</span>
		  </div>
		</div>
...
<div class="header-left float-left d-flex d-lg-flex d-md-block d-xs-block">
	<div class="logo">
            <a href="accueiltest.jsp"><img src="img/logos/Clothina-t.png" alt="NatureCircle"></a>		</div>		
	...
	<div class="container">
		...
		<li class="nav-item dropdown active">
                    <a class="nav-link text-uppercase" href="accueiltest.jsp">
			Accueil
...
<!--		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3">
		...
		<li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-uppercase" href="Shop.jsp">
			Boutique
		  <span class="sr-only">(current)</span>        </a>
		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3">
			<div class="sub-menu mb-xl-0 mb-4">
			  <ul class="list-unstyled">
				<li>
                                    <a class="menu-item pl-0" href="collection-homme.jsp">
					Collection Homme                </a>                </li>
				<li>
                                    <a class="menu-item pl-0" href="collection-femme.jsp">
				   Collection Femme                  </a>                </li>
				<li>
                                    <a class="menu-item pl-0" href="accessoire.jsp">
					Accessoire                 </a>                </li>
			  </ul>
                		...
                		<li class="nav-item dropdown mega-dropdown">
                                    <a class="nav-link text-uppercase" href="About-us.jsp">A propos</a>
<!--		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3" aria-labelledby="navbarDropdownMenuLink3">
		  <div class="row">
			...
			<div class="col-md-6 col-xl-4 sub-menu mb-0">
					...
					<ul class="list-unstyled">
				<li>
					<span class="menu-banner"><img src="img/banner/menuu-banner.jpg" alt="menu-banner"></span>                </li>
			  </ul>
			</div>
		  </div>
		</div>-->
		...
		<li class="nav-item dropdown">   
                    <a class="nav-link text-uppercase" href="Contact.jsp">Contact</a>
<!--		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3" aria-labelledby="navbarDropdownMenuLink5">
			<div class="sub-menu">
...
<!--                <li class="nav-item dropdown">   
                    <a class="nav-link text-uppercase" href="Actualités.jsp">Actualités</a>
		</li>-->
<!--		<li class="more_menu nav-item dropdown"><a href="#" class="nav-link dropdown-toggle text-uppercase">More</a><ul class="menu-dropdown cat-drop-menu"><li class="nav-item dropdown">   
		...
		<a class="nav-link text-uppercase" href="contact-us.html">@Clothina</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link text-uppercase" href="Actualités.jsp">Actualités</a></li></ul></li>-->
		...
		<!-- Features data-toggle="collapse"-->
		<li class="nav-item dropdown active">
                    <a class="nav-link dropdown-toggle text-uppercase" data-target="#menu1" aria-controls="menu1" aria-label="Toggle navigation" href="accueil.jsp">
			Accueil
		  <span class="sr-only">(current)</span>        </a>
<!--		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3" id="menu1">
			<div class="sub-menu mb-xl-0 mb-4">
			  <ul class="list-unstyled">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-uppercase" data-toggle="collapse" data-target="#menu2" aria-controls="menu2" aria-expanded="false" aria-label="Toggle navigation" href="Shop.jsp">
			Boutique
		  <span class="sr-only">(current)</span>        </a>
		<div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3" id="menu2">
			<div class="sub-menu mb-xl-0 mb-4">
                            <a href="Shop.jsp"><h6 class="sub-title text-uppercase font-weight-bold white-text">Catégorie</h6></a>
			  <ul class="list-unstyled">
				<li>
                                    <a class="menu-item pl-0" href="collection-homme.jsp">
					Collection Homme                </a>                </li>
                ...
                <li class="nav-item dropdown mega-dropdown">
                    <a class="nav-link dropdown-toggle text-uppercase" data-target="#menu3" aria-controls="menu3" aria-expanded aria-label="Toggle navigation" href="About-us.jsp">A propos</a>
...
<!--		<li class="nav-item dropdown">   
                    <a class="nav-link dropdown-toggle text-uppercase" data-target="#menu4" aria-controls="menu4" aria-expanded aria-label="Toggle navigation" href="Actualités.jsp">Actualités</a>
		...
		<li class="nav-item dropdown">
                    <a class="nav-link text-uppercase" href="Contact.jsp">Contact</a>      </li>
		
<!--		<li class="nav-item dropdown">   
		<a class="nav-link dropdown-toggle text-uppercase" data-toggle="collapse" data-target="#menu5" aria-controls="menu5" aria-expanded="false" aria-label="Toggle navigation">Pages</a>
		...
		<ul>
                    <!--<li><a href="#" class="text-capitalize" style="display: none;">mon compte</a></li>-->
			<li><a href="#" class="modal-view button" data-toggle="modal" data-target="#modalRegisterForm">s'inscrire</a></li>
			<li><a href="#" class="modal-view button" data-toggle="modal" data-target="#modalLoginForm">connexion</a></li>
		</ul>
		</div>
		</div>
                <%}else{%>
		...
		<div id="user-dropdown" class="user-menu">
		<ul>
			<li><a href="my-account.jsp" class="text-capitalize">mon compte</a></li>
<!--			<li><a href="#" class="modal-view button" data-toggle="modal" data-target="#modalRegisterForm" style="display: none;">s'inscrire</a></li>
			<li><a href="#" class="modal-view button" data-toggle="modal" data-target="#modalLoginForm" style="display: none;">connexion</a></li>-->
                        <li><button style="border: none;" type="submit" id="logout" value="logout"><a href="#">déconnexion</a></button></li>
		</ul>
		</div>
		</div>
                <%}%>
                ...
                <ul class="w-100 float-left">
                  <li>
                    <table class="table table-striped">
                      <tbody>
                        <tr>
                          <td class="text-center"><a href="#"><img src="img/products/001.jpg" alt="01" title="01"></a></td>
