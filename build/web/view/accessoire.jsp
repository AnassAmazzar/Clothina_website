<%-- 
    Document   : accessoire
    Created on : 26 mai 2022, 20:44:44
    Author     : anass
--%>
...
<%
    ...
    ResultSet R,T,U,Z;
    R = con.createStatement().executeQuery("select * from PRODUIT where IDCATEGORIE=4040");
//    T = con.createStatement().executeQuery("select IDPRODUIT from PRODUIT");
%>
<html>
    <head>
    ...
    <body id="category" class="layout4 layout2">
...
<nav aria-label="breadcrumb" class="w-100 float-left">
  <ol class="breadcrumb parallax justify-content-center" data-source-url="img/banner/parallaxx2.jpg" style="background-image: url(&quot;img/banner/parallaxx2.jpg&quot;); background-position: 50% 0.809717%;">
    ...
    <li class="breadcrumb-item active" aria-current="page">Accéssoire</li>
  </ol>
</nav>
		...
		<div class="container">
			<div class="row">
				...
				<div class="block-category mb-30 w-100 float-left">
					...
					<div class="title-category text-capitalize">Accéssoire</div>
            ...
            $(document).ready(function (){
                $('#<%=R.getString(1)%>').click(function(event){
                    $.ajax({
                        url:'/Clothina/AfficherPServlet',
                        dataType:'html',
                        type:'post',
                        data:'idProdt='+$('#<%=R.getString(1)%>').val(),
                        success:function(resulta){if(resulta!=0){window.location.replace("produit.jsp");}else{alert("ERREUR");}},
				...
				<div class="product-layouts col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                <div class="product-thumb">
                                        ...
                                        <div class="thumb-description">
                                                <div class="caption">
                                                    <h4 class="product-title text-capitalize"><button id="<%=R.getString(1)%>" type="submit" value="<%=R.getString(1)%>" style="border: none; background: none;"><a href="#"><%=R.getString(3)%></a></button></h4>
