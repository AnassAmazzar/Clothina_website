            ...
            $(document).ready(function(){
                $('#decon').click(function(event){
                    $.ajax({
                        ...
                        success:function(resulta){if(resulta!=0){window.location.replace("Servletadmin");}else{alert("Utilisateur exisste deja");}},
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="http://192.168.8.101:8080/Clothina/view/accueiltest.jsp">Home</a></li>
