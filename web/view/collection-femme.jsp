<%-- 
    Document   : colection_femme
    Created on : 26 mai 2022, 20:41:30
    Author     : anass
--%>
...
<%
    ...
    ResultSet R,T,U,Z;
    R = con.createStatement().executeQuery("select * from PRODUIT where IDCATEGORIE=3010");
%>
<html>
    <head>
...
<nav aria-label="breadcrumb" class="w-100 float-left">
  <ol class="breadcrumb parallax justify-content-center" data-source-url="img/banner/parallaxx2.jpg" style="background-image: url(&quot;img/banner/parallaxx2.jpg&quot;); background-position: 50% 0.809717%;">
    ...
    <li class="breadcrumb-item active" aria-current="page">collection-femme</li>
  </ol>
</nav>
